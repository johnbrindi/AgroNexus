...
lets edit the maketplace screen again

i want the all listing and categories to be selectable

like you can either have all listing or you choose a category and when you choose a category it opens a list that displays a couple of items in a tabular form i.ethe specific crop item for example maize, beans, carrot

So if a specify category is chosen then next to category the name must appear and then 

the items in the list below change accordingly

and all listing color should change 

then for each card the name should appear first then the price at the lower end 

when someone clicks the plus icon/Button
open a modal 
with a Crop photo area permitting users the ability to upload up to 2 pictures in a tap to upload photo area
then followed by textfields and title that is Crop NamedNodeMap, Quantity(kg/cup/bucket),price(XAF/Unit)
,location and description and a measurment that has a radio for bucket and kg(since most locals don't have measuring tools)
then a cancel and List Crop(in green)